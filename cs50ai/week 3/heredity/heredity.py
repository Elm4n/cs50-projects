...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        # Determine whether person has trait
        has_trait = person in have_trait

        # If no parents listed, use unconditional probability
        if mother is None and father is None:
            prob_gene = PROBS["gene"][genes]
        else:
            # Otherwise, calculate based on inheritance
            probs = {}
            ...
            mom_pass = probs[mother]
            dad_pass = probs[father]
